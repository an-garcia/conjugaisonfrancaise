...
public final class Constants {
    ...
    public static final String MOST_COMMON_250 = "250";
    public static final String MOST_COMMON_500 = "500";
    public static final String MOST_COMMON_1000 = "1000";
    ...
    public static final String DISPLAY_SORT_TYPE = "display_sort_type";
    public static final String DISPLAY_COMMON_TYPE = "display_common_type";
    ...
    public static final String TYPE_CONTEXT_HELP = "Context Help";
    ...
    public static final String TYPE_VERB_NOTIFICATION = "Verb Notification";
    public static final String TYPE_START_NOTIFICATIONS = "Start Scheduled Verb Notifications";
    public static final String TYPE_STOP_NOTIFICATIONS = "Stop Scheduled Verb Notifications";
    ...
    public static final String FILES_AUTHORITY = "com.xengar.android.englishverbs";
    public static final String VERBS = "verbs";
    public static final String VERB = "verb_";
     ...
     */
    public static final boolean USE_TEST_ALARM_INTERVALS = false;
